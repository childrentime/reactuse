...
description: >-
  `useBroadcastChannel` is a hook that allows you to use the `BroadcastChannel API` in your components. Learn usage patterns, best practices, and code examples
  fo
---
# useBroadcastChannel
