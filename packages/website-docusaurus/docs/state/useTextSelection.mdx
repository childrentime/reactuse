...
description: >-
  Track user text selection based on [document.getSelection](https://developer.mozilla.org/en-US/docs/Web/API/Document/getSelection). Learn usage patterns, best
  p
---
# useTextSelection
