...
description: >-
  React utility hook that returns a function that forces component to re-render when called. Learn usage patterns, best practices, and code examples for React
  dev
---
# useUpdate
